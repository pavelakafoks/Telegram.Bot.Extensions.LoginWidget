...
namespace Telegram.Bot.Extensions.LoginWidget
{
    ...
    public class LoginWidget : IDisposable
    {
        ...
        /// <param name="allowedTimeOffset">How old (in seconds) can authorization attempts be to be considered valid (compared to the auth_date field)
        /// <returns></returns>
        public Authorization CheckAuthorization(SortedDictionary<string, string> fields, int allowedTimeOffset = 30)
        {
